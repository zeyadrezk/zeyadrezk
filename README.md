...
| Enterprise ERP | Multi-tenant ERP system with microservices, RBAC, GIS integration, and queue-based processing — **Backend Developer.** | |
...
| CRM Systems | Built multiple CRM solutions — Healthcare CRM, Real Estate CRM, and delivery platform with multi-dashboard system. **Stack:** Laravel, Filament, Livewire, MySQL | |
| Clinic | Clinic management system with dashboard — **Backend Developer.** | |
